...
RolesController.post(`${rolePath}`, async(request: Request, response: Response) => {
...
RolesController.get(`${rolePath}`, async(request: Request, response: Response) => {
...
RolesController.put(`${rolePath}/:identification`, async(request: Request, response: Response) => {
...
RolesController.delete(`${rolePath}/:identification`, async(request: Request, response: Response) => {
    const roleId = request.params.identification;
